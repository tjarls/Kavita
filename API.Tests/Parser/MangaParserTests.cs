...
namespace API.Tests.Parser
{
    public class MangaParserTests
    {
        ...
        [InlineData("A Compendium of Ghosts - 031 - The Third Story_ Part 12 (Digital) (Cobalt001)", "0")]
        [InlineData("Akame ga KILL! ZERO (2016-2019) (Digital) (LuCaZ)", "0")]
        [InlineData("Akiiro Bousou Biyori - 01.jpg", "0")]
        [InlineData("Akutsu-San! - Chapter 038.5 - Volume Announcement.cbz", "0")]
        [InlineData("[BAA]_Darker_than_Black_c1", "0")]
        [InlineData("[BAA]_Darker_than_Black_Omake-1.zip", "0")]
        [InlineData("Baketeriya ch01-05.zip", "0")]
        [InlineData("Beelzebub_01_[Noodles].zip", "0")]
        [InlineData("Beelzebub_153b_RHS.zip", "0")]
        [InlineData("Beelzebub_172_RHS.zip", "0")]
        [InlineData("Black Bullet - v4 c17 [batoto]", "4")]
        [InlineData("Chapter 19 [Dametrans].zip", "0")]
        [InlineData("Corpse Party -The Anthology- Sachikos game of love Hysteric Birthday 2U Chapter 01", "0")]
        [InlineData("Cynthia the Mission 29.rar", "0")]
        [InlineData("Dance in the Vampire Bund v16-17", "16-17")]
        [InlineData("Darling in the FranXX - Volume 01.cbz", "1")]
        [InlineData("[dmntsf.net] One Piece - Digital Colored Comics Vol. 20.5-21.5 Ch. 177", "20.5-21.5")]
        [InlineData("Fullmetal Alchemist chapters 101-108.cbz", "0")]
        [InlineData("Goblin Slayer - Brand New Day 006.5 (2019) (Digital) (danke-Empire)", "0")]
        [InlineData("Grand Blue Dreaming - SP02", "0")]
        [InlineData("Grand Blue Dreaming - SP02 Extra (2019) (Digital) (danke-Empire).cbz", "0")]
        [InlineData("Green Worldz - Chapter 027", "0")]
        [InlineData("Hinowa ga CRUSH! 018 (2019) (Digital) (LuCaZ).cbz", "0")]
        [InlineData("Hinowa ga CRUSH! 018.5 (2019) (Digital) (LuCaZ).cbz", "0")]
        [InlineData("Historys Strongest Disciple Kenichi_v11_c90.5-100.5", "11")]
        [InlineData("Ichiban_Ushiro_no_Daimaou_v04_ch34_[VISCANS].zip", "4")]
        [InlineData("Ichinensei_ni_Nacchattara_v01_ch01_[Taruby]_v1.1.zip", "1")]
        [InlineData("It's Witching Time! 001 (Digital) (Anonymous1234)", "0", Skip = "Needs fixing in parser")]
        [InlineData("Kimi no Koto ga Daidaidaidaidaisuki na 100-nin no Kanojo Chapter 11-10", "0")]
        [InlineData("Knights of Sidonia c000 (S2 LE BD Omake - BLAME!) [Habanero Scans]", "2")]
        [InlineData("Kodoja #001 (March 2016)", "0")]
        [InlineData("Kodomo no Jikan vol. 10", "10")]
        [InlineData("Mad Chimera World - Volume 005 - Chapter 026.cbz", "5")]
        [InlineData("Magi - Ch.252-005.cbz", "0")]
        [InlineData("Mahoutsukai to Deshi no Futekisetsu na Kankei Chp. 1", "0")]
        [InlineData("Momo The Blood Taker - Chapter 027 Violent Emotion.cbz", "0")]
        [InlineData("My Charms Are Wasted on Kuroiwa Medaka - Ch. 37.5 - Volume Extras", "0")]
        [InlineData("Noblesse - Episode 429 (74 Pages).7z", "0")]
        [InlineData("Please Go Home, Akutsu-San! - Chapter 038.5 - Volume Announcement.cbz", "0")]
        [InlineData("[SugoiSugoi]_NEEDLESS_Vol.2_-_Disk_The_Informant_5_[ENG].rar", "2")]
        [InlineData("Tenjo Tenge {Full Contact Edition} v01 (2011) (Digital) (ASTC).cbz", "1")]
        [InlineData("The Duke of Death and His Black Maid - Vol. 04 Ch. 054.5 - V4 Omake", "4")]
        [InlineData("To Love Ru v01 Uncensored (Ch.001-007)", "1")]
        [InlineData("Tonikaku Kawaii (Ch 59-67) (Ongoing)", "0")]
        [InlineData("Umineko no Naku Koro ni - Episode 1 - Legend of the Golden Witch #1", "0")]
        [InlineData("VanDread-v01-c01.zip", "1")]
        [InlineData("Vol 1 Chapter 2", "1")]
        [InlineData("Yumekui-Merry_DKThias_Chapter21.zip", "0")]
        [InlineData("Yuusha Ga Shinda! - Vol.tbd Chapter 27.001 V2 Infection ①.cbz", "0", Skip = "Needs fixing in parser")]
        ...
        [InlineData("A Compendium of Ghosts - 031 - The Third Story_ Part 12 (Digital) (Cobalt001)", "A Compendium of Ghosts", Skip = "Needs fixing in parser")]
        [InlineData("Akutsu-San! - Chapter 038.5 - Volume Announcement.cbz", "Akutsu-San!")]
        [InlineData("[BAA]_Darker_than_Black_c1", "Darker than Black")]
        [InlineData("Beelzebub_01_[Noodles].zip", "Beelzebub")]
        [InlineData("Beelzebub_153b_RHS.zip", "Beelzebub")]
        [InlineData("Black Bullet - v4 c17 [batoto]", "Black Bullet")]
        [InlineData("Chapter 19 [Dametrans].zip", "")]
        [InlineData("Dance in the Vampire Bund v16-17", "Dance in the Vampire Bund")]
        [InlineData("[dmntsf.net] One Piece - Digital Colored Comics Vol. 20.5-21.5 Ch. 177", "One Piece - Digital Colored Comics")]
        [InlineData("Grand Blue Dreaming - SP02", "Grand Blue Dreaming")]
        [InlineData("Green Worldz - Chapter 027", "Green Worldz")]
        [InlineData("Hinowa ga CRUSH! 018 (2019) (Digital) (LuCaZ).cbz", "Hinowa ga CRUSH!")]
        [InlineData("Hinowa ga CRUSH! 018.5 (2019) (Digital) (LuCaZ).cbz", "Hinowa ga CRUSH!")]
        [InlineData("Historys Strongest Disciple Kenichi_v11_c90.5-100.5", "Historys Strongest Disciple Kenichi")]
        [InlineData("Kimi no Koto ga Daidaidaidaidaisuki na 100-nin no Kanojo Chapter 11-10", "Kimi no Koto ga Daidaidaidaidaisuki na 100-nin no Kanojo")]
        [InlineData("Kodomo no Jikan vol. 10", "Kodomo no Jikan")]
        [InlineData("Mahoutsukai to Deshi no Futekisetsu na Kankei Chp. 1", "Mahoutsukai to Deshi no Futekisetsu na Kankei")]
        [InlineData("NEEDLESS_Vol.4_-Simeon_6_v2[SugoiSugoi].rar", "NEEDLESS")]
        [InlineData("Noblesse - Episode 429 (74 Pages).7z", "Noblesse")]
        [InlineData("[Suihei Kiki]_Kasumi_Otoko_no_Ko_[Taruby]_v1.1.zip", "Kasumi Otoko no Ko")]
        [InlineData("Tenjo Tenge {Full Contact Edition} v01 (2011) (Digital) (ASTC).cbz", "Tenjo Tenge {Full Contact Edition}")]
        [InlineData("To Love Ru v01 Uncensored (Ch.001-007)", "To Love Ru")]
        [InlineData("Umineko no Naku Koro ni - Episode 3 - Banquet of the Golden Witch #02.cbz", "Umineko no Naku Koro ni")]
        [InlineData("VanDread-v01-c01.zip", "VanDread")]
        [InlineData("vol_356-1", "")] // Mangapy syntax
        [InlineData("Vol 1 Chapter 2", "")]
        [InlineData("Yumekui-Merry_DKThias_Chapter21.zip", "Yumekui-Merry DKThias")]
        ...
        [InlineData("A Compendium of Ghosts - 031 - The Third Story_ Part 12 (Digital) (Cobalt001)", "31")]
        [InlineData("Akame ga KILL! ZERO (2016-2019) (Digital) (LuCaZ)", "0")]
        [InlineData("Akiiro Bousou Biyori - 01.jpg", "1")]
        [InlineData("Akutsu-San! - Chapter 038.5 - Volume Announcement.cbz", "38.5")]
        [InlineData("[BAA]_Darker_than_Black_c1", "1")]
        [InlineData("[BAA]_Darker_than_Black_Omake-1.zip", "0")]
        [InlineData("Baketeriya ch01-05.zip", "1-5")]
        [InlineData("Beelzebub_172_RHS.zip", "172")]
        [InlineData("Black Bullet", "0")]
        [InlineData("Black Bullet - v4 c17 [batoto]", "17")]
        [InlineData("Chapter 19 [Dametrans].zip", "19")]
        [InlineData("Corpse Party -The Anthology- Sachikos game of love Hysteric Birthday 2U Chapter 01", "1")]
        [InlineData("Cynthia the Mission 29.rar", "29")]
        [InlineData("Dance in the Vampire Bund v16-17", "0")]
        [InlineData("Darling in the FranXX - Volume 01.cbz", "0", Skip = "Needs fixing in parser")]
        [InlineData("[dmntsf.net] One Piece - Digital Colored Comics Vol. 20.5-21.5 Ch. 177", "177")]
        [InlineData("[dmntsf.net] One Piece - Digital Colored Comics Vol. 20 Ch. 177 - 30 Million vs 81 Million.cbz", "177")]
        [InlineData("Goblin Slayer - Brand New Day 006.5 (2019) (Digital) (danke-Empire)", "6.5")]
        [InlineData("Grand Blue Dreaming - SP02", "0")]
        [InlineData("Grand Blue Dreaming - SP02 Extra (2019) (Digital) (danke-Empire).cbz", "0")]
        [InlineData("Green Worldz - Chapter 027", "27")]
        [InlineData("Hinowa ga CRUSH! 018.5 (2019) (Digital) (LuCaZ).cbz", "18.5")]
        [InlineData("Historys Strongest Disciple Kenichi_v11_c90.5-100.5", "90.5-100.5")]
        [InlineData("Ichiban_Ushiro_no_Daimaou_v04_ch34_[VISCANS].zip", "34")]
        [InlineData("Ichinensei_ni_Nacchattara_v01_ch01_[Taruby]_v1.1.zip", "1")]
        [InlineData("It's Witching Time! 001 (Digital) (Anonymous1234)", "1")]
        [InlineData("Kimi no Koto ga Daidaidaidaidaisuki na 100-nin no Kanojo Chapter 11-10", "11-10")]
        [InlineData("Knights of Sidonia c000 (S2 LE BD Omake - BLAME!) [Habanero Scans]", "0")]
        [InlineData("Kodomo no Jikan vol. 10", "0")]
        [InlineData("Mad Chimera World - Volume 005 - Chapter 026.cbz", "26")]
        [InlineData("Magi - Ch.252-005.cbz", "252-5")]
        [InlineData("Mahoutsukai to Deshi no Futekisetsu na Kankei Chp. 1", "1")]
        [InlineData("Momo The Blood Taker - Chapter 027 Violent Emotion.cbz", "27")]
        [InlineData("My Charms Are Wasted on Kuroiwa Medaka - Ch. 37.5 - Volume Extras", "37.5")]
        [InlineData("NEEDLESS_Vol.4_-Simeon_6_v2[SugoiSugoi].rar", "6", Skip = "Needs fixing in parser")]
        [InlineData("Please Go Home, Akutsu-San! - Chapter 038.5 - Volume Announcement.cbz", "38.5")]
        [InlineData("[SugoiSugoi]_NEEDLESS_Vol.2_-_Disk_The_Informant_5_[ENG].rar", "5", Skip = "Needs fixing in parser")]
        [InlineData("Tenjo Tenge {Full Contact Edition} v01 (2011) (Digital) (ASTC).cbz", "0")]
        [InlineData("The Duke of Death and His Black Maid - Vol. 04 Ch. 054.5 - V4 Omake", "54.5")]
        [InlineData("To Love Ru v01 Uncensored (Ch.001-007)", "1-7")]
        [InlineData("Tonikaku Cawaii [Volume 11].cbz", "0", Skip = "Needs fixing in parser")]
        [InlineData("Tonikaku Kawaii (Ch 59-67) (Ongoing)", "59-67")]
        [InlineData("VanDread-v01-c01.zip", "1")]
        [InlineData("vol_356-1", "1", Skip = "Needs fixing in parser")] // Mangapy syntax
        [InlineData("Vol 1 Chapter 2", "2")]
        [InlineData("[xPearse] Kyochuu Rettou Volume 1 [English] [Manga] [Volume Scans]", "0", Skip = "Needs fixing in parser")]
        [InlineData("Yuusha Ga Shinda! - Vol.tbd Chapter 27.001 V2 Infection ①.cbz", "27.001")]
